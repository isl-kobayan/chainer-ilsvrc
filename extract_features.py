...
def main(args):
    ...
    #if args.test:
    #print(val_extractor.confmat)
    #categories = dataio.load_categories(args.categories)
    #confmat_csv_name = args.initmodel + '.csv'
    #confmat_fig_name = args.initmodel + '.eps'
    #dataio.save_confmat_csv(confmat_csv_name, val_extractor.confmat, categories)
    #dataio.save_confmat_fig(confmat_fig_name, val_extractor.confmat, categories,
